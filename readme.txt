...
- Sistema Cardápio (Nome do plugin)
- sistema-cardapio (nome dos arquivos, nome do text domain e slug da url do repositório)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Sistema Cardápio, através do próprio sistema de atualizações do WordPress
